...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = prove contextual nonincrease for surviving repeated-mode source walks, then formalize finite simple-cycle decomposition and uniform epsilon
