...
GENERAL_K_CHAIN:
  ...
  MODULE_2_NORMALIZE_ONE_STATUS = EXACT_NORMAL_VALUE_AND_CRITICAL_NODE_BOUNDS_PRESERVED
  MODULE_2_REMAINING = strengthen the canonical step to consume preserved CriticalNodeBounds; iterate; termination; uniqueness
