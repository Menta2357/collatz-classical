...
GENERAL_K_CHAIN:
  ...
  MODULE_2_LOCAL_SELF_SIMILARITY_STATUS = SOURCE_SPLIT_TRANSLATION_EQUIVARIANCE_PROVED
  MODULE_2_IMMEDIATE_BLOCKER = full source expansion-deletion termination and order independence
