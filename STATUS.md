...
GENERAL_K_CHAIN:
  ...
  MODULE_2_LOCAL_SELF_SIMILARITY_STATUS = FINITE_EXPLICITLY_MATCHED_RAW_SPLIT_TRACES_TRANSLATE_EQUIVARIANTLY
  MODULE_2_IMMEDIATE_BLOCKER = extend the proved D1/D3 canonical minPath translation to the three branch paths, transport witnessRetention under explicit sign hypotheses, and close sourceStep translation; sign-sensitive scheduling remains separate
