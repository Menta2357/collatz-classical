...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = iterate the provenanced scheduler, derive unbounded genealogy depth from nontermination, extract a surviving infinite branch, and prove segment admissibility plus branch-shift nonnegativity
