...
GENERAL_K_CHAIN:
  ...
  MODULE_2_CONTEXT_TRANSPORT_STATUS = CRITICAL_NODE_BOUNDS_TRANSPORTED_ACROSS_BELOW_CRITICALITY_EQUIVALENT_CONTEXTS
  MODULE_2_REMAINING = retained-branch criticality equivalence and critical-node-bounds preservation by deletion; iterated normalizer locating and applying local steps; termination; uniqueness
