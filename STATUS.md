...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = extract one coherent infinite branch from unbounded finite provenances, then prove segment admissibility plus branch-shift nonnegativity
