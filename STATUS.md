...
GENERAL_K_CHAIN:
  ...
  MODULE_2_REMAINING = retained-branch directed criticality dominance and critical-node-bounds preservation by deletion; iterated normalizer locating and applying local steps; termination; uniqueness
