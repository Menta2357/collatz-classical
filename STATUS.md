...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = extract a genealogy-coherent infinite typed SourceWalk from hypothetical scheduler nontermination and prove segment admissibility plus branch-shift nonnegativity
