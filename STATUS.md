...
GENERAL_K_CHAIN:
  ...
  MODULE_2_FIRST_RETURN_STATUS = FIRST_PIVOT_SPLIT_AND_EXACT_FIRST_RETURN_LIST_DECOMPOSITION_PROVED
  MODULE_2_FINITE_NEAR_ZERO_CONSUMER_STATUS = UNIFORM_NEGATIVE_GAP_PROVED_CONDITIONALLY_ON_LOCAL_FINITENESS
  MODULE_2_IMMEDIATE_BLOCKER = prove first-return packages finite above a lower bound from the smaller support, then close finite_admissible_walks_above by induction on finite mode support
