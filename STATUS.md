...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = lift the complete source scheduler step to provenanced trees, then extract a surviving infinite branch and prove segment admissibility plus branch-shift nonnegativity
