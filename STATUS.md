...
GENERAL_K_CHAIN:
  ...
  MODULE_2_IMMEDIATE_BLOCKER = prove source retention-policy correspondence and control sign-sensitive scheduling, or replace self-similarity by a well-founded cycle descent
