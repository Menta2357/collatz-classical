...
This checkpoint formalizes two source-faithful components of the termination
...
scoping note. It also does not claim EL termination, order independence, a
canonical normal form, or `SatisfiesEL`.
