...
overlay_base="$repo_root/.lake/f3-v6-audit-overlay"
...
printf '%s\n' \
  ...
  "V6_OVERLAY_ROOT=$overlay_root" \
  "V6_OVERLAY_REPAIR_SHA256=$repair_hash" \
  "V6_OVERLAY_EXACT_CORE_SHA256=$exact_hash" \
  'V6_OVERLAY_FILE_COUNT=2'
