...
printf '%s\n' \
  'F3_FORWARD_V3_A1=PASS' \
  'F3_FORWARD_V3_A1_LEAN_EXIT_STATUS=0'
printf 'F3_FORWARD_V3_A1_HEAD=%s\n' "$(git -C "$repo" rev-parse HEAD)"
printf 'F3_FORWARD_V3_AUDIT_OLEAN_SHA256=%s\n' \
  "$(shasum -a 256 "$audit_olean" | awk '{print $1}')"
printf 'F3_FORWARD_V3_AUDIT_ILEAN_SHA256=%s\n' \
