...
printf '%s\n' \
  'F3_FORWARD_V3_C0=PASS' \
  'F3_FORWARD_V3_C0_LEAN_EXIT_STATUS=0'
printf 'F3_FORWARD_V3_C0_HEAD=%s\n' "$(git -C "$repo" rev-parse HEAD)"
printf 'F3_FORWARD_V3_TARGET_OLEAN_SHA256=%s\n' \
  "$(shasum -a 256 "$target_olean" | awk '{print $1}')"
printf 'F3_FORWARD_V3_TARGET_ILEAN_SHA256=%s\n' \
