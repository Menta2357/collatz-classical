...
overlay="$repo/.lake/f3-forward-right-certificate-v4-overlay/lib/lean"
...
verify_base_environment() {
  ...
  check_hash "$source_file" 75fb6b9b4f89f65df7e67b0b87704b17f0814950f17418d067ac1881bddc9f88
