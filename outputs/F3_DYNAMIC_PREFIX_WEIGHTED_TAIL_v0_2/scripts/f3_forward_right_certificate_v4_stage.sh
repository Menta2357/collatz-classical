...
stage_parent="$repo/.lake/f3-forward-right-certificate-v4-overlay/lib/lean"
stage_collatz="$stage_parent/CollatzClassical"
expected_manifest="$repo/outputs/F3_DYNAMIC_PREFIX_WEIGHTED_TAIL_v0_2/results/F3_FORWARD_RIGHT_CERTIFICATE_V4/F3_FORWARD_RIGHT_CERTIFICATE_V4_EXPECTED_STAGE_MANIFEST.sha256"
...
printf '%s\n' \
  'F3_FORWARD_V4_STAGE=PASS' \
  'F3_FORWARD_V4_STAGE_FILE_COUNT=209' \
  'F3_FORWARD_V4_STAGE_OLEAN_COUNT=209' \
  'F3_FORWARD_V4_STAGE_ILEAN_COUNT=0' \
  'F3_FORWARD_V4_STAGE_SYMLINK_COUNT=0'
printf 'F3_FORWARD_V4_STAGE_TREE_SHA256=%s\n' "$(tree_hash "$stage_collatz")"
