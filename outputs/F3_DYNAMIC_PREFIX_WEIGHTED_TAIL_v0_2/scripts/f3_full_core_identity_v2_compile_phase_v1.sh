...
test "$(unique_value FULL_CORE_IDENTITY_V2_OVERLAY_STAGE "$s0_log")" = 'PASS'
test "$(unique_value FULL_CORE_IDENTITY_V2_S0_WRAPPER_EXIT_STATUS "$s0_log")" = '0'
...
printf '%s\n' 'FULL_CORE_IDENTITY_V2_C0_PREFLIGHT=PASS'
printf 'FULL_CORE_IDENTITY_V2_C0_SOURCE_SHA256=%s\n' "$source_hash"
printf 'FULL_CORE_IDENTITY_V2_C0_EXACT_CORE_SHA256=%s\n' "$exact_hash"
printf 'FULL_CORE_IDENTITY_V2_C0_REPAIR_SHA256=%s\n' "$repair_hash"
printf 'FULL_CORE_IDENTITY_V2_C0_DECODER_SHA256=%s\n' "$decoder_hash"
...
printf 'FULL_CORE_IDENTITY_V2_C0_LEAN_EXIT_STATUS=%s\n' "$lean_status"
...
printf '%s\n' \
  'FULL_CORE_IDENTITY_V2_C0=PASS' \
  'FULL_CORE_IDENTITY_V2_OVERLAY_FILE_COUNT_AFTER_C0=5' \
  'FULL_CORE_IDENTITY_V2_OVERLAY_SYMLINK_COUNT_AFTER_C0=0'
printf 'FULL_CORE_IDENTITY_V2_OLEAN_SHA256=%s\n' \
  "$(shasum -a 256 "$target_olean" | awk '{print $1}')"
printf 'FULL_CORE_IDENTITY_V2_ILEAN_SHA256=%s\n' \
