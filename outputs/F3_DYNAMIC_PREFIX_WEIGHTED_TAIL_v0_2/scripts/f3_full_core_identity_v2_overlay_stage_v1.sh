...
printf '%s\n' \
  'FULL_CORE_IDENTITY_V2_OVERLAY_STAGE=PASS' \
  "FULL_CORE_IDENTITY_V2_OVERLAY_ROOT=$overlay_root" \
  "FULL_CORE_IDENTITY_V2_EXACT_CORE_SHA256=$exact_hash" \
  "FULL_CORE_IDENTITY_V2_REPAIR_SHA256=$repair_hash" \
  "FULL_CORE_IDENTITY_V2_DECODER_SHA256=$decoder_hash" \
  'FULL_CORE_IDENTITY_V2_OVERLAY_FILE_COUNT=3' \
  'FULL_CORE_IDENTITY_V2_OVERLAY_SYMLINK_COUNT=0'
